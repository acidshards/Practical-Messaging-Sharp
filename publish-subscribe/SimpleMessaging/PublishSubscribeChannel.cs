    ...
    public class PublishSubscribeChannel : IDisposable
    {
        ...
        public PublishSubscribeChannel(ChannelType channelType, string hostName = "localhost")
        {
            ...
            if (channelType == ChannelType.Subscriber)
            {
                ...
                var queueDeclare = _channel.QueueDeclare(queue: string.Empty, durable: false, exclusive: true, autoDelete: true, arguments: null);
                ...
                _channel.QueueBind(queue: _queueName, exchange: ExchangeName, routingKey: ALL, arguments: null);
            }
        }
